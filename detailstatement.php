...
<div class="col-sm-3" align="left"><br><button type="button" class="btn" onclick="LoadDefault()">Get Detail</button></div>
...
<script>
	...
	function GetWorkSlip(workslipid)
	{
		$.post("ajaxpages/showworkslip.php",
		{
	...
	{
		$.post("ajaxpages/showpayslip.php",
		{
			payslipid:payslipid,
		},
		function(data, status){
	...
	function LoadDefault()
	{
		...
		$(".loader").show();		
		$.post("ajaxpages/detailstatement.php",
		{
			frmdate:frmdate,
			todate:todate,
			locations:locations,
