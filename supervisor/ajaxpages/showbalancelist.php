...
$rs_el	=	$dbconnection->firequery("select * from customertest_tbl where centerid=".$centerid." and staffid=".$staffid." and date(creationdate) between '".$frmdate."' and '".$todate."' and balance>0 order by creationdate");
