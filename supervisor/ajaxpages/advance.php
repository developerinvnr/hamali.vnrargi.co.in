...
<tr>
	...
	<td align="center"><?php echo date('d\-m\-Y',strtotime($row['advancedate'])); $cols++;?></td>	
	<td><?php echo $row['groupname']; $cols++;?></td>
	<td><?php echo $row['amount']; $cols++;?></td>	
	<td><?php echo $row['paymentmode']; $cols++;?></td>	
	<td><?php echo $row['cdno']; $cols++;?></td>	
	<td><?php echo $row['bankname']; $cols++;?></td>	
