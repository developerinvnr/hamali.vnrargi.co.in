...
if($_POST['workcode']!="" && $_POST['quantity']!="")
{
...
<tr>
	...
	<td style="width:0px; padding:0px;"><button style="padding-left:0px; padding-top:0px; padding-right:0px; padding-bottom:0px; background-color:#31708f; border:none; color:#FFFFFF; font-size:12px; font-weight:bold; width:100px; height:25px;" onclick="AddButton()" tabindex="<?php echo $t++;?>">Add</button></td>
</tr>
...
<button style="padding-left:0px; padding-top:0px; padding-right:0px; padding-bottom:0px; background-color:#9191FF; border:none; color:#FFFFFF; font-size:12px; font-weight:bold; width:150px; height:25px; float:right;" onclick="SubmitForm()" tabindex="<?php echo $t++;?>">SUBMIT</button>	
	</td>
</tr>
