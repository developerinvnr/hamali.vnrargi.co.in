...
<tr>
	...
	{
	?>
		<a href="./vnr_mainindex?m=<?php echo $_REQUEST['m'];?>&p=<?php echo encrypt("editextendedworkslip");?>&slipid=<?php echo $row['workslipid'];?>"><i class="fa fa-edit"></i></a>
	<?php
	}
	else
	{
...
<tr id="rec<?php echo $i;?>" style="display:none;" class="bg-info text-white wrec"><td id="recd<?php echo $i;?>" colspan="11" style="width:100%;"></td></tr>
<?php
}
if($j>0)
{
