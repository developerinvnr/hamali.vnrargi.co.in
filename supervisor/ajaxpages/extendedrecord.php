		...
		if(is_array($_SESSION['records']))
		{
			...
			if($rateid!=0)
			{
				...
				if($o>0)
				{
					...
					{
						$_SESSION['records'][$max]['narration']=	$actionvalue." ".$verb." ".$material." ".$product." ".$notation;
					}
					else if($_POST['rem1']=="" && $_POST['rem2']!="")
					{
						$_SESSION['records'][$max]['narration']=	$actionvalue." ".$verb." ".$material." ".$_POST['rem2']." ".$notation;
					}
					else if($_POST['rem1']!="" && $_POST['rem2']=="")
					{
						$_SESSION['records'][$max]['narration']=	$actionvalue." ".$verb." ".$_POST['rem1']." ".$product." ".$notation;
					}
					else
					{
						$_SESSION['records'][$max]['narration']=	$actionvalue." ".$verb." ".$_POST['rem1']." ".$_POST['rem2']." ".$notation;					
					}
					$_SESSION['records'][$max]['rate']			=	$price;
					$_SESSION['records'][$max]['total']			=	$price*$_POST['quantity'];
				}
				unset($rs_list);
				unset($rs);
			}
		...
		else
		{
			...
			if($rateid!=0)
			{
				...
				if($o>0)
				{
					if($_POST['rem1']=="" && $_POST['rem2']=="")
					{
						$_SESSION['records'][0]['narration']=	$actionvalue." ".$verb." ".$material." ".$product." ".$notation;
					}
					else if($_POST['rem1']=="" && $_POST['rem2']!="")
					{
						$_SESSION['records'][0]['narration']=	$actionvalue." ".$verb." ".$material." ".$_POST['rem2']." ".$notation;
					}
					else if($_POST['rem1']!="" && $_POST['rem2']=="")
					{
						$_SESSION['records'][0]['narration']=	$actionvalue." ".$verb." ".$_POST['rem1']." ".$product." ".$notation;
					}
					else
					{
						$_SESSION['records'][0]['narration']=	$actionvalue." ".$verb." ".$_POST['rem1']." ".$_POST['rem2']." ".$notation;					
					}
					
					$_SESSION['records'][0]['rate']		=	$price;
					$_SESSION['records'][0]['total']	=	$price*$_POST['quantity'];
				}
				unset($rs_list);
				unset($rs);
			}
...
<tr>
	...
	<td style="padding:0px; width:70px;">
		<input type="text" name="rem1[]" readonly class="form-control" id="rem1<?php echo $i;?>" value="<?php echo $_SESSION['records'][$key]['rem1'];?>" autocomplete="off" tabindex="<?php echo $t++;?>" onKeyPress="return OnKeyPress(this, event)" style="padding-left:2px; padding-top:0px; padding-bottom:0px; padding-right:0px; height:25px; font-size:12px;" />
	</td>
	<td style="padding:0px; width:70px;">
		<input type="text" name="rem2[]" readonly class="form-control" id="rem2<?php echo $i;?>" value="<?php echo $_SESSION['records'][$key]['rem2'];?>" autocomplete="off" tabindex="<?php echo $t++;?>" onKeyPress="return OnKeyPress(this, event)" style="padding-left:2px; padding-top:0px; padding-bottom:0px; padding-right:0px; height:25px; font-size:12px;"/>
	</td>
