...
if(isset($_SESSION['supervisordetail'][0]['sessionid']))
{
	...
	$query	=	"select * from workslip_tbl where supervisorid=".$_SESSION['supervisordetail'][0]['sessionid']." and paymentstatus=0 ";
...
?>
<tr>
	<td class="center" id="action"><input type="checkbox" class="slips" onclick="SelectSlip()" name="slipid<?php echo $i;?>" id="slipid<?php echo $i;?>" value="<?php echo $row['workslipid'];?>" style="float:left;" /><?php echo $i; $cols++;?></td>
