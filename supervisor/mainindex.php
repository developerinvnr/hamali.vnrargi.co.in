		...
		<div id="navbar" class="navbar navbar-default ace-save-state" style="background-color:#008c40!important;">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="./mainindex.php" class="navbar-brand"><!--<small>ANU<span style="color:red;">G</span><span style="color:white;">RAH</span>--> VNR SUPERVISOR PANEL</small></a>
				</div>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle" style="background-color:#008c40!important;">
								<span class="user-info"><small>Welcome,</small><?php echo $_SESSION['supervisordetail'][0]['authname'];?></span>
