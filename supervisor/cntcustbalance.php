			...
			<thead>
				<tr>
					...
					<div id="tablehead">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						From : <input type="date" name="frmdate" id="frmdate" class="selectbc" style="padding:0px;" onchange="LoadDefault()" value="<?php echo date('Y\-m\-01');?>" />
						To : <input type="date" name="todate" id="todate" class="selectbc" style="padding:0px;" onchange="LoadDefault()" value="<?php echo date('Y\-m\-d');?>" />						
					</div>
					</th>
				</tr>
...
<script>
	...
	function LoadDefault()
	{
		...
		$(".loader").show();		
		$.post("ajaxpages/cntcustbalance.php",
		{
			processname: "",
			cntname:cntname,
			frmdate:frmdate,
