		...
		<table class="table table-bordered table-hover" id="tablerecords">
			<thead>
				<tr>
					<th colspan="9">
<div id="tablehead">
	<select name="supervisorname" id="supervisorname" class="selectbx" onchange="GetCenter(this.value,'centername');LoadDefault();" tabindex="<?php echo $t++;?>">
	...
	<select name="centername" id="centername" class="selectbx" onchange="GetStaff(this.value,'staffname');LoadDefault();" tabindex="<?php echo $t++;?>">
...
<script>
	...
	function LoadDefault()
	{
		...
		$(".loader").show();		
		$.post("ajaxpages/ledgersummary.php",
		{
			processname: "",
