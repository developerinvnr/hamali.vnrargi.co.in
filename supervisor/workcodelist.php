		...
		<table class="table table-bordered table-hover" id="tablerecords">
			<thead>
				<tr>
					<th colspan="12">
					<div id="tablehead">
						<select name="gpname" id="gpname" class="selectbx" onchange="LoadDefault()">
						<option value="">--Select Hamali Group Name--</option>
						<?php
						$rs_gp	=	$dbconnection->firequery("select * from hamaligroup_tbl where companyname=".$_SESSION['supervisordetail'][0]['companyid']." and locationname=".$_SESSION['supervisordetail'][0]['locationid']."");
						while($gp=mysqli_fetch_assoc($rs_gp))
						{
						?>
					...
					<a href="./printing/printworkcodelist.php" target="_blank"><button type="button" class="btn" style="float:right;">PRINT WORK CODE LIST</button></a>
					</th>
				</tr>
			</thead>
...
<script>
	...
	function LoadDefault()
	{
		...
		$(".loader").show();		
		$.post("ajaxpages/workcodelist.php",
		{
			gpname:gpname,
			m:m,
			p:p,
