...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	if($_POST['acn']=="save")
	{
		...
		if($flag==0)
		{
			if($dbconnection->isRecordExist("select * from supervisor_tbl where password='".$_POST['oldpassword']."' and supervisorid=".$_SESSION['supervisordetail'][0]['sessionid'].""))
			{
				$dbconnection->firequery("update supervisor_tbl set password='".$_POST['newpassword']."' where supervisorid=".$_SESSION['supervisordetail'][0]['sessionid']."");
