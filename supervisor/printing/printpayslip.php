...
<?php
	$rs_slip	=	$dbconnection->firequery("select * from paymentslip_tbl where slipid=".$_REQUEST['slipid']."");
...
<?php
$paid	=	0;
$rs_pay	=	$dbconnection->firequery("select * from payment_detail where payslipid=".$_REQUEST['slipid']." order by paymentdate");
...
?>
<tr><td colspan="4" align="center" style="font-size:14px; font-weight:bold;">BALANCE AMOUNT : <?php echo $total-$paid;?></td></tr>
</table>	
	</td>
</tr>
</table>
