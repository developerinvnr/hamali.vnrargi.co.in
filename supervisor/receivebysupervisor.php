		...
		<table class="table table-bordered table-hover" id="tablerecords">
			<thead>
				<tr>
					<th colspan="9">
					<div id="tablehead">
						<select name="supervisorname" id="supervisorname" class="selectbx" onchange="LoadDefault();GetCenter(this.value,'centername');" tabindex="<?php echo $t++;?>">
							...
							{
							?>
							<option value="<?php echo $frn['supervisorid'];?>"><?php echo $frn['supervisorname'];?></option>
							<?php
							}
							?>							
						</select>
						<select name="centername" id="centername" class="selectbx" onchange="LoadDefault();GetStaff(this.value,'staffname')" tabindex="<?php echo $t++;?>">
							<option value="">--Center Name--</option>
						</select>
						<select name="staffname" id="staffname" class="selectbx" onchange="LoadDefault()" tabindex="<?php echo $t++;?>">
							<option value="">--Staff Name--</option>
						</select>
					From Date : <input type="date" name="frmdate" id="frmdate" class="selectbx" style="padding:0px;" value="<?php echo date('Y\-m\-01');?>" onchange="LoadDefault()" />
...
<script>
	...
	function LoadDefault()
	{
		...
		$(".loader").show();		
		$.post("ajaxpages/receivebysupervisor.php",
			{
				processname: "",
