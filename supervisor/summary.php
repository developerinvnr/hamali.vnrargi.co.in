		...
		<table class="table table-bordered table-hover" id="tablerecords">
			<thead>
				<tr>
					...
					To Date : <input type="date" name="todate" id="todate" class="selectbx" style="padding:0px;" value="<?php echo date('Y\-m\-t');?>" onchange="LoadDefault()" />						
