...
$sessionid	=	$_SESSION['logindetail'][0]['sessionid'];
...
$rs_last	=	$dbconnection->firequery("select * from login_history where userid=".$_SESSION['datadetail'][0]['sessionid']." order by loginid desc limit 1");
