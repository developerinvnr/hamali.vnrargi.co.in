...
if(isset($_SESSION['datadetail'][0]['sessionid']))
{
	...
	if($searchvalue!='')
	{
		$query.=	"where unitname like '%$searchvalue%' ";
	}
	$start	=	$pagesize*($pagenumber-1);
	$query.=	" order by unitname limit $start, $pagesize";
...
<tr>
	...
	<td><?php echo $row['unitname']; $cols++;?></td>
...
?>
<tr>
	<td colspan="4" style="padding:0px; text-align:center;">
