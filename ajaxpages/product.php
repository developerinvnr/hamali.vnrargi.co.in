...
if(isset($_SESSION['datadetail'][0]['sessionid']))
{
	...
	if($searchvalue!='')
	{
		$query.=	"where (productname like '%$searchvalue%' or operatorname like '%$searchvalue%' or unit like '%$searchvalue%') ";
	}
...
?>
<tr>
	<td class="center" id="action"><?php echo $row['productid']; $cols++;?></td>
	<td><?php echo $row['productname']; $cols++;?></td>
	<td><?php echo $row['operatorname']; $cols++;?></td>	
