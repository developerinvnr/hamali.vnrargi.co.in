...
if(isset($_SESSION['datadetail'][0]['sessionid']))
{
	...
	$query	=	"select * from workcode_tbl ";
	if($searchvalue!='')
	{
		$query.=	"where (actionname like '%$searchvalue%' or verb like '%$searchvalue%') ";
	}
...
$rs_count	=	$dbconnection->firequery("select * from workcode_tbl");
...
<tr>
	...
	<td><?php echo $row['actionname']; $cols++;?></td>
