...
if(isset($_SESSION['datadetail'][0]['sessionid']))
{
	...
	$query	=	"select * from $tablename a inner join state_tbl b on b.stateid=a.statename ";
	if($searchvalue!='')
	{
		$query.=	"where a.cityname like '%$searchvalue%' or b.statename like '%$searchvalue%' ";
	}
...
<tr>
	...
	<td><?php echo $dbconnection->getField("state_tbl","statename","stateid=".$row['stateid'].""); $cols++;?></td>
	<td><?php echo $row['cityname']; $cols++;?></td>
