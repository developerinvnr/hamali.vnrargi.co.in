...
<form name="pagedata" id="pagedata" method="post" action="#" style="overflow:auto;">
...
<tr><td colspan="10">Payslip Number : <b><?php echo $payslipnumber;?></b> Payment Slip Date : <b><?php echo $payslipdate;?></b> &nbsp;&nbsp;Plant/Location Name : <b><?php echo $location;?></b>,&nbsp;&nbsp;&nbsp;&nbsp; Hamali Group Name : <b><?php echo $groupname;?> [<?php echo $contact;?>]</b></td></tr>
<tr>
...
?>
<tr>
	<td colspan="8" align="right"><b>Total</b></td><td align="center"><b><?php echo $total;?></b></td><td></td></tr>
</tr>
<tr>
